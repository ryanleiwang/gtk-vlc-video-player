...
void play()
{
    ...
    if(is_fullscreen)
        gtk_button_set_image(GTK_BUTTON(full_screen_pause_button), pause_icon_image);
    else
        gtk_button_set_image(GTK_BUTTON(pause_button), pause_icon_image);
}
...
void main_window_init()
{
    ...
    g_signal_connect(pause_button, "clicked", G_CALLBACK(on_playpause), NULL);
